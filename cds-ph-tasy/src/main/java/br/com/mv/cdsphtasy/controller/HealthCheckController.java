...
public class HealthCheckController {
    ...
    @RequestMapping(value = "/api-Personal H/health-check", method = RequestMethod.GET, produces = { "application/json"})
    ...
    public ResponseEntity<String> HealthCheck() {
        return new ResponseEntity<>("I'm alive - Api Personal H!", HttpStatus.OK);
    }
